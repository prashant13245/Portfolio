...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/prashant-trivedi-47331a25a/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@prashanttrivedi976",
    icon: Instagram,
    url: "https://www.instagram.com/prashanttrivedi976/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@prashant13245",
    icon: Github,
    url: "https://github.com/prashant13245",
    color: "#ffffff",
...
//     gradient: "from-[#000000] via-[#25F4EE] to-[#FE2C55]"
  ...
  icon: ({ className, ...props }) => (
    <svg
      ...
      {...props}
    >
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.5 11.24H16.19l-5.003-6.545L5.34 21.75H2.03l7.73-8.835L1.5 2.25h6.113l4.56 6.062L18.244 2.25zm-1.16 17.52h1.833L7.013 4.113H5.07l12.015 15.657z" />
    </svg>
  ),
  url: "https://x.com/PrashantTr24355?t=NSZ7p_6bBFBOF7u93TPVwA&s=09",
  color: "#1DA1F2",
  gradient: "from-[#1DA1F2] via-[#0A84FF] to-[#000000]"
}
