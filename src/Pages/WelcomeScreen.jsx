...
{
  [
    { Icon: Code2, url: "https://leetcode.com/u/prashanttrivedi976/" },
    { Icon: User, url: "https://www.linkedin.com/in/prashant-trivedi-47331a25a/" },
    { Icon: Github, url: "https://github.com/prashant13245" }
  ].map((item, index) => (
    <IconButton
      key={index}
      Icon={item.Icon}
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="prashanttrivedi" />
                    </span>
                  </div>
                </a>
              </motion.div>
